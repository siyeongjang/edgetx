...
void LvglWidgetArc::clearRefs(lua_State *L)
{
  ...
  clearRef(L, bgColor.function);
  clearRef(L, bgOpacity.function);
  clearRef(L, bgStartAngle.function);
  clearRef(L, bgEndAngle.function);
...
{
  if (textColor.changedColor(newColor)) {
